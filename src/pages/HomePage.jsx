    ...
    return (
        <>
            ...
            <section className="image-section row">
                <img className='img-slide' src="https://ecommo--ion.bluenile.com/static-dyo-bn/DYO_Banner.dde8f.jpg" alt="choose_settings" />
                <div className="overlay-content col-xl-5">
