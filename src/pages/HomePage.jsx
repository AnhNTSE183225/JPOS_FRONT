            ...
            <div className={`${styles['home-page']}`}>
                <section className={`${styles['home']}`}>
                    ...
                    <div className={`${styles[`overlay-content-video`]} col-xl-4`}>
                        <p className='fs-4 text-center'>Design Your Own Engagement Ring</p>
                ...
                <section className={`${styles['row']}`}>
                    ...
                    <div className={`${styles[`overlay-content`]} col-xl-5`}>
                        ...
                        <a href="/diamond-price-list"><button style={{width: "45%"}}>Watch Diamond Price List</button></a>
                    </div>
                </section>
                <section className={`mt-5 ${styles['row']}`}>
                    ...
                    <div className={`${styles[`overlay-content`]} col-xl-5`}>
                        ...
                        <p>Embark on a journey towards a proposal as unique as your love story. With our bespoke engagement rings, 
